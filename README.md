...
- 🧩 **扩展插件** — 课体细分+课名 · 十二长生 · 五行旺衰 · 神煞补充 · 本命行年 · **毕法赋命中**（《畢法賦》百法，首批 23 法机器检测），可独立开关
- 📜 **典籍库** — 内置《占事略決》全书 + 《六壬大全》全书十三篇（序、起例、神將釋、歌賦、兵占、宿度分野、課經集一~四、畢法賦上下；双书并册、离线可读），古法排盘深链原文条文、毕法命中断辞可溯源
...
| [lrdq-ts-lib](https://github.com/hackninety/lrdq-ts-lib) | 毕法命中插件 + 典籍 | 《六壬大全》全书典籍（四庫全書本十三篇，`lrdq-ts-lib/docs` 子入口随典籍抽屉懒加载）；《畢法賦》百法语料，首批 23 法机器命中（exact/approx 分级） |
