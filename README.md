...
- 📜 **典籍库** — 内置《占事略決》全书 + 《六壬大全》畢法賦上下（双书并册、离线可读），古法排盘深链原文条文、毕法命中断辞可溯源
...
| [lrdq-ts-lib](https://github.com/hackninety/lrdq-ts-lib) | 毕法命中插件 + 典籍 | 《六壬大全》卷十一/十二《畢法賦》百法语料（四庫全書本），首批 23 法机器命中（exact/approx 分级） |
