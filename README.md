...
- 🧩 **扩展插件** — 课体细分+课名 · 十二长生 · 五行旺衰 · 神煞补充 · **大全神煞**（《六壬大全》卷一立成：三表落支入传标记 + 课传各位当月吉凶神） · 本命行年 · **毕法赋命中**（《畢法賦》百法，97/100 法机器检测，年命类法随本命行年插件联动），可独立开关
...
- 📋 **数据导出 & AI 案卷** — JSON / Markdown 双格式复制与文件导出（MD 更省 token、AI 可直接阅读，含毕法命中、大全神煞、**关系摘要**（机器核算生克刑冲，AI 免自算五行）、**类神**（卷二神將釋要点）、**课体原文引**两书互证节文）· **占事定向 AI Prompt**（婚姻/疾病/求财等 13 类，自动附《指南》《心鏡》对应断法章节，六步推理流程、断必有据）
